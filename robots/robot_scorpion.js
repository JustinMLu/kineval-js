...
robot.joints.neck.origin = {xyz: [0.0,0.0,1.2], rpy:[0,0,0]};
robot.joints.neck.axis = [1.0,0.0,0.0]; 

robot.joints.tail_shoulder = {parent:"base", child:"tail_upper"};
robot.joints.tail_shoulder.origin = {xyz: [0.0,0.0,-1.2], rpy:[0,0,0]};
robot.joints.tail_shoulder.axis = [1.0,0.0,0.0]; 

robot.joints.tail_elbow = {parent:"tail_upper", child:"tail_lower"};
robot.joints.tail_elbow.origin = {xyz: [0.0,1.0,0.0], rpy:[0,0,0]};
robot.joints.tail_elbow.axis = [1.0,0.0,0.0]; 
...
links_geom["head"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0.1, 0.1) );

links_geom["tail_upper"] = new THREE.CubeGeometry( 0.3, 1, 0.3 );
links_geom["tail_upper"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0.5, 0) );

links_geom["tail_lower"] = new THREE.CubeGeometry( 0.3, 1, 0.3 );
links_geom["tail_lower"].applyMatrix( new THREE.Matrix4().makeTranslation(0, 0.5, 0) );
